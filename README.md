...
const mosques = await fetch(
  'https://raw.githubusercontent.com/YOUR_USERNAME/muis-api-unofficial/main/mosque-directory/data.json'
).then(r => r.json());

// ARS directory
const ars = await fetch(
  'https://raw.githubusercontent.com/YOUR_USERNAME/muis-api-unofficial/main/ars-directory/data.json'
).then(r => r.json());

// IECP directory
const iecp = await fetch(
  'https://raw.githubusercontent.com/YOUR_USERNAME/muis-api-unofficial/main/iecp-directory/data.json'
).then(r => r.json());
```
